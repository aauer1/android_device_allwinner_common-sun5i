 ...
 * 
 * @param fbuilder    - The framebuilder to add a projobdrawcall to
 * @param indexed -  is it an indexed draw call
 ...
 */
u32 _mali_projob_add_gp_drawcall(struct mali_frame_builder* frame_builder, u64* cmnds, struct bs_shaderpass* projob_pass, mali_bool indexed);
